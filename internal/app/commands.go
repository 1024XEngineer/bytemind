...
var defaultSlashCommands = []SlashCommand{
	...
	{Name: "/agents", Usage: "/agents [name]", Description: "List available subagents or show one definition"},
	{Name: "/explorer", Usage: "/explorer", Description: "Show the builtin explorer subagent definition"},
	{Name: "/review", Usage: "/review", Description: "Show the builtin review subagent definition"},
