...
func (m model) helpText() string {
	return strings.Join([]string{
		...
		"- `/models`: show configured providers and discovered models; switch with Up/Down + Enter.",
		"- `/model add`: open the setup flow to add or configure a provider/model.",
		"- `/model delete`: open the configured model list and delete one target.",
