...
var commandItems = []commandItem{
	...
	{Name: "/review", Usage: "/review <task>", Description: "Delegate a focused code review task to the builtin review subagent.", Kind: "command"},
	{Name: "/explorer", Usage: "/explorer <task>", Description: "Delegate a focused repository exploration task to the builtin explorer subagent.", Kind: "command"},
...
func shouldExecuteFromPalette(item commandItem) bool {
	...
	switch item.Name {
	case "/help", "/session", "/agents", "/review", "/explorer", "/skills", "/skill clear", "/mcp list", "/mcp help", "/new", "/compact", "/quit":
		return true
	default:
		return false
	}
